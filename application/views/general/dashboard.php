        ...
        <div class="card p-30">
            <div class="media">
                ...
                <div class="media-body media-text-right">
                    <h2>568120</h2>
                    <p class="m-b-0"><?=$this->lang->line('dashboard_revenue')?></p>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card p-30">
            <div class="media">
                ...
                <div class="media-body media-text-right">
                    <h2>1178</h2>
                    <p class="m-b-0"><?=$this->lang->line('dashboard_sales')?></p>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card p-30">
            <div class="media">
                ...
                <div class="media-body media-text-right">
                    <h2>25</h2>
                    <p class="m-b-0"><?=$this->lang->line('dashboard_store')?></p>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card p-30">
            <div class="media">
                ...
                <div class="media-body media-text-right">
                    <h2>847</h2>
                    <p class="m-b-0"><?=$this->lang->line('dashboard_customer')?></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="testimonial-widget-one owl-carousel owl-theme">
                    <div class="item">
                        <div class="testimonial-content">
                            <img class="testimonial-author-img" src="<?=base_url()?>user_ussets/images/avatar/2.jpg" alt="" />
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <img class="testimonial-author-img" src="<?=base_url()?>user_ussets/images/avatar/3.jpg" alt="" />
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <img class="testimonial-author-img" src="<?=base_url()?>user_ussets/images/avatar/1.jpg" alt="" />
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <img class="testimonial-author-img" src="<?=base_url()?>user_ussets/images/avatar/4.jpg" alt="" />
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <img class="testimonial-author-img" src="<?=base_url()?>user_ussets/images/avatar/5.jpg" alt="" />
                            <div class="testimonial-author">TYRION LANNISTER</div>
                            <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <img class="testimonial-author-img" src="<?=base_url()?>user_ussets/images/avatar/6.jpg" alt="" />
                            <div class="testimonial-author">TYRION LANNISTER</div>
                            <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="round-img">
                                        <a href=""><img src="<?=base_url()?>user_ussets/images/avatar/4.jpg" alt=""></a>
                                    </div>
                                </td>
                                <td>John Abraham</td>
                            ...
                            <tr>
                                <td>
                                    <div class="round-img">
                                        <a href=""><img src="<?=base_url()?>user_ussets/images/avatar/2.jpg" alt=""></a>
                                    </div>
                                </td>
                                <td>John Abraham</td>
                            ...
                            <tr>
                                <td>
                                    <div class="round-img">
                                        <a href=""><img src="<?=base_url()?>user_ussets/images/avatar/3.jpg" alt=""></a>
                                    </div>
                                </td>
                                <td>John Abraham</td>
...
<div class="row">
                ...
                <div class="recent-comment">
                    <div class="media">
                        <div class="media-left">
                            <a href="#"><img alt="..." src="<?=base_url()?>user_ussets/images/avatar/1.jpg" class="media-object"></a>
                        </div>
 ...
 <!-- Amchart -->
    ...
    <script src="<?=base_url()?>user_ussets/js/lib/calendar-2/moment.latest.min.js"></script>
    <!-- scripit init-->
    <script src="<?=base_url()?>user_ussets/js/lib/calendar-2/semantic.ui.min.js"></script>
    <!-- scripit init-->
    <script src="<?=base_url()?>user_ussets/js/lib/calendar-2/prism.min.js"></script>
    <!-- scripit init-->
    <script src="<?=base_url()?>user_ussets/js/lib/calendar-2/pignose.calendar.min.js"></script>
    <!-- scripit init-->
